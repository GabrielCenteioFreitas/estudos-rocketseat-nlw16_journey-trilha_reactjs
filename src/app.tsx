        ...
        <div className="space-y-4">
          ...
          {isGuestsInputOpen && (
            <div className="p-4 bg-zinc-900 rounded-xl flex items-center shadow-shape gap-3">
              ...
              <button onClick={openConfirmTripModal} className="bg-lime-300 hover:bg-lime-400 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2">
                Confirmar viagem
                <ArrowRight className="size-5" />
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            ...
            <form onSubmit={addNewEmailToInvite} className="p-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2">
              ...
              <button type="submit" className="bg-lime-300 hover:bg-lime-400 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2">
                Convidar
          ...
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            <div className="space-y-2">
              ...
              <p className="text-sm text-zinc-400">
                ...
                <span className="font-semibold">Florianópolis, Brasil</span>{" "}
                nas datas de{" "}
                <span className="font-semibold">16 a 27 de Agosto de 2024</span>{" "}
            ...
            <form onSubmit={addNewEmailToInvite} className="space-y-3">
              ...
              <button type="submit" className="w-full justify-center bg-lime-300 hover:bg-lime-400 text-lime-950 rounded-lg px-5 h-11 font-medium flex items-center gap-2">
